...
class ISETTA_API_DECLARE NetworkManager {
 public:
  ...
  /**
   * @brief Unregisters the corresponding callback function on the client for connecting to
   * the server.
   *
  ...
  /**
   * @brief Unregisters the corresponding callback function on the client for disconnecting from
   * the server.
   *
   * @param handle Handle of the callback function to unregister
   */
  ...
  /**
   * @brief Registers a callback function that is called when the server gets a client connected to it.
   *
   * @param listener Callback function
   * @return U64 Handle of the callback function in the registry
   */
  ...
  /**
   * @brief Unregisters the corresponding callback function on the server for connecting to the server.
   *
   * @param handle Handle of the callback function to unregister
   */
  void UnregisterClientConnectedCallback(U64& handle) const;
  /**
   * @brief Registers a callback function that is called when the server gets a client disconnected from it.
   *
   * @param listener Callback function
   * @return U64 Handle of the callback function in the registry
   */
  ...
  /**
   * @brief Unregisters the corresponding callback function on the server for disconnecting from the server.
   *
   * @param handle Handle of the callback function to unregister
   */
