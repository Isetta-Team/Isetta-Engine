...
Entity* Primitive::Create(Type type, std::string name,
                          bool withCollider) {
  ...
  switch (type) {
    case Type::Capsule:
      ...
      entity->AddComponent<MeshComponent>(
          "primitives\\Capsule\\Capsule.scene.xml", true);
    ...
    case Type::Cylinder:
      entity->SetName(name);
      entity->AddComponent<MeshComponent>(
          "primitives\\Cylinder\\Cylinder.scene.xml", true);
      if (withCollider) entity->AddComponent<CapsuleCollider>();
      break;
    case Type::Grid:
      entity->SetName(name);
    ...
    case Type::Sphere:
      entity->SetName(name);
      entity->AddComponent<MeshComponent>(
          "primitives\\Sphere\\Sphere.scene.xml", true);
