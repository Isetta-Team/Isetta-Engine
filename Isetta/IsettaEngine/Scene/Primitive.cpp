...
Entity* Primitive::Create(Type type, bool withCollider) {
  ...
  switch (type) {
    case Type::Capsule:
      ...
      entity->AddComponent<MeshComponent>("primitives\\Capsule\\Capsule.scene.xml",
                                          true);
      if (withCollider) entity->AddComponent<CapsuleCollider>();
      break;
    case Type::Cube:
      entity->SetName("Cube");
      entity->AddComponent<MeshComponent>("primitives\\Cube\\Cube.scene.xml", true);
      if (withCollider) entity->AddComponent<BoxCollider>();
      break;
    case Type::Cylinder:
      entity->SetName("Cylinder");
      entity->AddComponent<MeshComponent>("primitives\\Cylinder\\Cylinder.scene.xml",
                                          true);
      if (withCollider) entity->AddComponent<CapsuleCollider>();
      break;
    case Type::Grid:
      entity->SetName("Grid");
      entity->AddComponent<MeshComponent>("primitives\\Grid\\Grid.scene.xml", true);
      if (withCollider)
    ...
    case Type::Quad:
      entity->SetName("Quad");
      entity->AddComponent<MeshComponent>("primitives\\Quad\\Quad.scene.xml", true);
      if (withCollider)
        entity->AddComponent<BoxCollider>(Math::Vector3::zero,
    ...
    case Type::Sphere:
      ...
      entity->AddComponent<MeshComponent>("primitives\\Sphere\\Sphere.scene.xml", true);
